      ...
      <div className="container">
        ...
        <div className="post">
          ...
          <ol>
            ...
            <li>Donation, which takes 10-15 minutes</li>
            <li>Rest and refreshments to prevent dizziness</li>
          </ol>
        ...
        <div className="post">
          ...
          <ul>
            <li><strong>Whole Blood Donation:</strong> The most common type, used in emergencies and surgeries.</li>
            <li><strong>Platelet Donation:</strong> Helps patients with cancer, organ transplants, or severe injuries.</li>
            <li><strong>Plasma Donation:</strong> Used for patients with clotting disorders and severe burns.</li>
        ...
        <div className="post">
          ...
          <ul>
            ...
            <li>Eat a nutritious meal rich in iron</li>
            <li>Avoid alcohol and fatty foods before donating</li>
        ...
        <div className="post">
          ...
          <ul>
            <li><strong>Myth:</strong> Blood donation weakens the body. <strong>Fact:</strong> The body replenishes lost blood within 24-48 hours.</li>
            <li><strong>Myth:</strong> You can contract diseases from donating. <strong>Fact:</strong> All equipment is sterile and single-use.</li>
        ...
        <div className="post">
          ...
          <ul>
            ...
            <li>Nonprofit organizations like the Red Cross</li>
        ...
        <div className="post">
          ...
          <p><strong>Does blood donation hurt?</strong> Only a slight pinch is felt when the needle is inserted, but the process is generally painless.</p>
        </div>
      </div>
    </div>
  );
