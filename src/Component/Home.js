...
export default function Home() {
  ...
  return (
    <>
            ...
            {[...Array(3)].map((_, index) => (
              ...
              >
                <img
                  src={
                    index === 0
                      ? "https://images.unsplash.com/photo-1615461066841-6116e61058f4?q=80&w=1583&auto=format&fit=crop"
                      : index === 1
                      ? "https://images.unsplash.com/photo-1536856136534-bb679c52a9aa?q=80&w=1470&auto=format&fit=crop"
                      : "https://images.unsplash.com/photo-1606206591513-adbfbdd7a177?q=80&w=1470&auto=format&fit=crop"
                  }
      ...
      {/* The rest of your content (How it works, Services, etc.) remains unchanged */}
      {/* How it works */}
                    ...
                    <div className="card-body">
                      ...
                      <div>
                        <button
                          type="button"
                          className="btn btn-danger"
                          onClick={() => navigate("/bloodbanklocator")}
                        >
                          Enquire now
                        </button>
                      </div>
